...
router.post("/editBookInstanceReserved", urlencoder, async (req, res) => {
    console.log("req.session.username " + req.session.username)
    console.log("req.body.editbookinstance_id " + req.body.editbookinstance_id)
    let userID = req.session.username;
    let instanceID = req.body.editbookinstance_id;
...
router.post("/chageDueDateInstance", urlencoder, async (req, res) => {
    console.log("req.session.username " + req.session.username)
    console.log("req.body.editbookinstance_id " + req.body.editbookinstance_id)
    let userID = req.session.username;
    let instanceID = req.body.editbookinstance_id;
...
router.post("/returnBookInstance", urlencoder, async (req, res) => {
    console.log("req.session.username " + req.session.username)
    console.log("req.body.editbookinstance_id " + req.body.editbookinstance_id)
    let userID = req.session.username;
    let instanceID = req.body.editbookinstance_id;
